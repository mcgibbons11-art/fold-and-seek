 ...
 */
export const GROUND_ACCELERATION_SECONDS = 0.18;
export const GROUND_STOP_SECONDS = 0.09;
 ...
 * over a kerb becomes a commitment made at takeoff: at 0.6 a body that hits an
 ...
 */
export const AIR_CONTROL_SCALE = 0.6;
